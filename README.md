...
仿照vue双向绑定，模仿[DMQ](https://github.com/DMQ/mvvm)写了个简易的vue，所有代码均在core文件夹中
...
```
这里已经实现了一个Observer了，已经具备了监听数据和数据变化通知订阅者的功能，[完整代码](https://github.com/demi798/vue-mvvm/blob/master/core/observer.js)。那么接下来就是实现Compile了
...
至此，一个简单的Compile就完成了，[完整代码](https://github.com/demi798/vue-mvvm/blob/master/core/compile.js)。接下来要看看Watcher这个订阅者的具体实现了
...
ok, Watcher也已经实现了，[完整代码](https://github.com/demi798/vue-mvvm/blob/master/core/watcher.js)。
...
至此，全部模块和功能已经完成了，如本文开头所承诺的两点。一个简单的MVVM模块已经实现，其思想和原理大部分来自经过简化改造的vue[源码](https://github.com/vuejs/vue)，猛戳[这里](https://github.com/demi798/vue-mvvm/blob/master/core/mvvm.js)可以看到本文的所有相关代码。
